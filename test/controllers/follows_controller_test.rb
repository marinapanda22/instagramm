...
class FollowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow" do
    assert_difference('Follow.count') do
      post follows_url, params: { follow: { follower_id: @follow.follower_id, following_id: @follow.following_id } }
    end
  ...
  test "should update follow" do
    patch follow_url(@follow), params: { follow: { follower_id: @follow.follower_id, following_id: @follow.following_id } }
